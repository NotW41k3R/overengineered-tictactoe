# This is the old version of the game, before I thought its not overengineered enough 
# and refactored it to OOP version and use an ndarray as the state instead of a nested list.

# Install Colorama to run this version
